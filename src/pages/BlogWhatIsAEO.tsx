    ...
    return (
        <div className="container animate-fade-in" style={{ paddingTop: "6rem", paddingBottom: "6rem" }}>
            ...
            <article style={{ maxWidth: "760px", margin: "0 auto" }}>
                ...
                <p style={P}>Strip away the acronym and AEO is four concrete workstreams. This is the structure I use with clients, and you can read <Link to="/services/aeo" style={linkStyle}>how I work as an AEO consultant</Link> on the service page.</p>
                ...
                <p style={P}>Retrofitting is the harder case, and the more common one. The <Link to="/case-study-seo" style={linkStyle}>SEO and AEO case study</Link> covers a catalogue that launched without either, then had both rebuilt into it page by page, and my <Link to="/services/aeo" style={linkStyle}>AEO consulting service</Link> is the same work packaged.</p>
