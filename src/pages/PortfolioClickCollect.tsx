...
export default function PortfolioClickCollect() {
    ...
    return (
        <>
        <Seo
            title="Click & Collect Mobile Experience | Portfolio"
            description="Click & collect mobile experience: app UX, campaign creative, and in-store elevator screen distribution for a high-traffic retail store, by Maria Madeira."
            path="/portfolio-click-collect"
        />
