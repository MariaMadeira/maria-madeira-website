            ...
            <div className="grid-2" style={{ alignItems: "flex-start", gap: "4rem" }}>
                ...
                <div className="reveal-right is-visible" style={{ transitionDelay: '0.2s' }}>
                    ...
                    <div style={{ display: "flex", flexDirection: "column", gap: "1.5rem", color: "var(--text-secondary)", fontSize: "1.15rem", lineHeight: 1.8 }}>
                        ...
                        <p>
                            My work spans the full funnel: from building Klaviyo lifecycle systems that generated £134K in attributed revenue over 12 months, to managing Google Ads campaigns that acquired customers at a £12.78 cost per conversion, to building a Click & Collect app and designing custom AI prompt systems for SEO, AEO, and visual content production.
                        </p>
